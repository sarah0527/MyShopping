                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <select name="productType" class="form-control" id="productType">
                                        <option value="1">粉红猪小妹</option>
                                        <option value="2">米奇妙妙屋</option>
                                        <option value="3">海底小纵队</option>
                                        <option value="4">天线宝宝</option>
                                        <option value="5">乐高积木</option>
                                        <option value="6">熊熊乐园</option>
                                        <option value="7">汪汪队</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
