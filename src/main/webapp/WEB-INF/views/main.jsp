		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">粉红猪小妹 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">米奇妙妙屋</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">海底小纵队</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">天线宝宝</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">乐高积木</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">熊熊乐园</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">汪汪队</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到贝贝佳玩具城</h1>
					<p>贝贝佳玩具城是一个非常优秀的购物网站，你可以在这里买到物美价廉的东西</p>
				</div>
